...
class Lua53 < Formula
  ...
  ## mirror "https://mirrors.kernel.org/debian/pool/main/l/lua5.2/lua5.2_5.3.0.orig.tar.gz" TODO - add mirror
  ...
  patch do ## TODO: Patch reported to work with 5.3-beta, does it work with 5.3 final?
  ...
  patch do ## TODO: Does this patch work with 5.3?
  ...
  def install
    ...
    # Fix some software potentially hunting for different pc names. - Uncomment if/when merged into homebrew/homebrew
    #ln_s "#{bin}/lua", "#{bin}/lua5.3"
    #ln_s "#{bin}/lua", "#{bin}/lua-5.3"
    #ln_s "#{bin}/luac", "#{bin}/luac5.3"
    #ln_s "#{bin}/luac", "#{bin}/luac-5.3"
    #ln_s "#{include}", "#{include}/lua5.3"
    #ln_s "#{lib}/pkgconfig/lua.pc", "#{lib}/pkgconfig/lua5.3.pc"
    #ln_s "#{lib}/pkgconfig/lua.pc", "#{lib}/pkgconfig/lua-5.3.pc"
  end
